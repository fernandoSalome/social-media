  ...
  if (!isset($login_cookie)) {
	...
	if (isset($_POST['save'])) {
		if ($_FILES["file"]["error"]>0) {
			...
			if ($data) {
				header("Location: capa_fundo.php");
			}else{
				echo "<script language='javascript' type='text/javascript'>alert('Ocorreu um erro ao tentar colocar sua foto de perfil...');</script>";
			}
		}
	}
?>
<html>
	...
	<div class="container painel-login">
		<div class="row">
			<div class="col-md-12">
				<h2 class="text-center">Adicione uma foto de perfil</h2>
